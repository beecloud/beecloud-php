...
try {
    ...
    foreach($bills as $list) {
        $agree_refund = $list->spay_result ? "<a href='un.agree.refund.php?refund_no=".$refund_no."&bill_no=".$list->bill_no."&refund_fee=".$list->total_fee."'>同意退款</a>" : "";
